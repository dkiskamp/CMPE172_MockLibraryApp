      ...
      return (
        <div className="base">
          ...
          <div className="book-data">
            <div className="bookName"><h2>{this.state.bookName}</h2></div>
            <div className="username"><h3>{this.state.bookTitle}</h3></div>
            <div className="amount"><h3></h3>{this.state.bookAuthor}</div>
          </div>
          </div>
        </div>
      );
